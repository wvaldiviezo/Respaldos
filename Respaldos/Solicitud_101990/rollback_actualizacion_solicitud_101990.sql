...
-------- Script original: rollback_actuaizacion_solicitud_101990.sql
------------------------------------------------------------------------------------------------

-- actualización de la data
print 'Actualización del ente y del ruc del cliente en la tabla cobis..cl_cliente '
print '1. Ente del Cliente antes de actualizar: 513579'
print '2. Ruc del Cliente antes de actualizar: 1768014410001'
...
set cl_cliente = 2360587, cl_ced_ruc = '0000000005001'
where cl_det_producto in (select dp_det_producto from cobis..cl_det_producto
where dp_cuenta in(
'4006656221',
'4006672073',
...
END
GO
print '1. Ente del Cliente después de actualizar: 2360587'
print '2. Ruc del cliente después de actualizar: 0000000005001'
print '---------------------------------------------------'
print '---------------------------------------------------'
print 'Actualización del ruc y del ente del cliente en la tabla cob_ahorros..ah_cuenta'
print '1. Ruc del Cliente antes de actualizar: 1768014410001'
print '2. Ente del Cliente antes de actualizar: 513579'
...
set ah_ced_ruc = '0000000005001', ah_cliente = 2360587
where ah_cta_banco in(
'4006656221',
'4006672073',
'4006677366',
...
END
GO
print '1. Ruc del cliente después de actualizar: 0000000005001'
print '2. Ente del Cliente después de actualizar: 2360587'
print '---------------------------------------------------'
print '---------------------------------------------------'
